...
<cfif IsDefined("FORM.PageDate") AND #FORM.PageDate# NEQ "">
	<cfset myyear = listfirst(form.PageDate, '-')>
...
<cfset PName = LCase(PName)>
  <cfquery result="pinsert">   
    INSERT INTO Posts (PageID, PageTitle, PageKeywords, PageDescription, PageImage, PageName, PageDir, PageText, PageDate, PageLast, UserID, LUserID, GalleryID, isSticky)
...
<cfif IsDefined("FORM.PageDate") AND #FORM.PageDate# NEQ "">
, <cfqueryparam value="#FORM.PageDate# #TimeFormat(now(), 'HH:mm:ss')#" cfsqltype="cf_sql_timestamp">
<cfelse>
...
, <cfqueryparam value="#session.userid#" cfsqltype="cf_sql_integer">
, <cfif IsDefined("FORM.GalleryID") AND isNumeric("FORM.GalleryID")>
<cfqueryparam value="#FORM.GalleryID#" cfsqltype="cf_sql_integer">
<cfelse>
'0'
</cfif>
, <cfif IsDefined("FORM.isSticky") AND #FORM.isSticky# NEQ "">
<cfqueryparam value="#FORM.isSticky#" cfsqltype="cf_sql_integer">
<cfelse>
'0'
</cfif>
)
...
Limit * 70 characters</p>
		  ...
		  <td colspan="2" class="formtext">
            	<h1>Post Date:</h1>
            	<p>The Post Date is: <strong><cfoutput>#DateFormat(Now(), 'yyyy-mm-dd')#</cfoutput></strong> it can be changed if needed, otherwise leave blank<br>
       ...
       <!---<tr>
          	<td width="335" class="formtext">
                ...
                <option value="0">Select a Page Category</option>
            ...
            <h1>Sticky Post:</h1>
                ...
                <p><strong>Sticky this post:</strong><cfinput type="checkbox" name="isSticky" value="1"></p>
            </td>
        </tr>  --->
...
<td colspan="2" class="formtext"><h1>News Text:</h1><textarea cols="100" id="editor_office2003" name="editor_office2003" rows="10"></textarea></td>
         ...
         <tr>
          ...
          <tr>
           <td colspan="2" class="oformtext">Photo Gallery:<br>
           <p>Choose a photo gallery from the list to have it displayed on this page</p>
           <p><select name="GalleryID">
                <option value="0">Select a Photo Gallery</option>
                <cfoutput query="GetGalleries">
                <option value="#GalleryID#">#GName#</option>
                </cfoutput>
                </select></p></td>
           <td>&nbsp;</td>
          </tr>
         ...
         <tr>
           ...
           <textarea name="PostDescription" cols="50" rows="5" maxlength="250"></textarea>
           </td>
           <td>&nbsp;</td>
          </tr>
         <tr>
