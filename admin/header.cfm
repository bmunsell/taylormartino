<!---<cfif isDefined('session.cbstorage.userauthorized') AND session.cbstorage.userauthorized>
<cfelse>
	<cfscript>location(url="/login/?error=1",addToken='no');</cfscript>
</cfif>--->
...
<ul id="MenuBar1" class="MenuBarHorizontal">
  ...
  <li><a class="MenuBarItemSubmenu" href="/admin/page-list.cfm"><img src="/admin/images/page.png" width="16" height="16"> PAGES&nbsp;</a>
    <ul>
      <li><a href="page-list.cfm"><img src="/admin/images/page_edit.png" width="16" height="16"> EDIT Pages</a></li>
      <li><a href="subpage-list.cfm"><img src="/admin/images/page_edit.png" width="16" height="16"> EDIT SubPages</a></li>
      <li><a href="page-add.cfm"><img src="/admin/images/page_add.png" width="16" height="16"> NEW Page</a></li>
      <li><a href="subpage-add.cfm"><img src="/admin/images/page_add.png" width="16" height="16"> NEW Sub-Page</a></li>
    </ul>
  </li>
