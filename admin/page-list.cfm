...
<!---SET MESSAGES--->
<cfset msg = 'Drag & Drop to change page display order'>
...
<li style="cursor: move;">
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
  		<tr>
    		<td width="42%"><h3>#Left(GetPages.PageLink, 70)#</h3>
    		...
    		<img src="/admin/images/page_edit.png" width="16" height="16" border="0" alt="Edit #GetPages.PageName# Subpages"><br /> 
    ...
    <img src="/admin/images/page_delete.png" width="16" height="16" border="0" alt="Delete #GetPages.PageLink#"><br />
    DELETE </a>--->
   	 		</td>
		</tr>
	</table>
