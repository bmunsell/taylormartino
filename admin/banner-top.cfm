...
<cfif IsDefined("FORM.MM_InsertRecord") AND FORM.MM_InsertRecord EQ "form1">
  <cfquery datasource="gsn">   
    INSERT INTO Scores (Home, Away, HScore, AScore, Period, TMinutes, TSeconds, GDate)
...
, <cfif IsDefined("FORM.TMinutes") AND #FORM.TMinutes# NEQ "">
<cfqueryparam value="#FORM.TMinutes#" cfsqltype="cf_sql_numeric">
<cfelse>
NULL
</cfif>
, <cfif IsDefined("FORM.TSeconds") AND #FORM.TSeconds# NEQ "">
<cfqueryparam value="#FORM.TSeconds#" cfsqltype="cf_sql_numeric">
<cfelse>
NULL
</cfif>
...
<tr>
  <td colspan="2" align="center"><strong>GSN TOP Banner AD Management</strong></td>
</tr>
<tr bgcolor="#1C558A">
  <td colspan="2">&nbsp;<b><font color="#FFFFFF">Add Banner</font></b></td>
</tr>
<tr valign="baseline">
...
<tr valign="baseline">
  ...
  <td><select name="TMinutes">
    <cfloop from="00" to="60" index="i" step="01">
      <cfoutput>
    ...
    :
    <select name="TSeconds">
      <cfloop from="00" to="60" index="i">
        <cfoutput>
          <option value="#NumberFormat(i, 00)#" >#NumberFormat(i, 00)#</option>
        </cfoutput>
        </cfloop>
